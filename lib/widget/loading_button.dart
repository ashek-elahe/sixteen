...
class LoadingButtonState extends State<LoadingButton>
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Center(
        child: _state.value == ButtonState.error ? cross : _state.value == ButtonState.success ? check : btn,
      ),
    );
  }
  ...
  void initState() {
    ...
    _bounceAnimation = Tween<double>(begin: 0, end: widget.height).animate(CurvedAnimation(
