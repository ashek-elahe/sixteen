...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_sslcommerz/flutter_sslcommerz.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/flutter_sslcommerz/SSLCommerzSDK.framework"
fi
